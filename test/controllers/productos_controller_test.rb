...
class ProductosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create producto" do
    assert_difference('Producto.count') do
      post productos_url, params: { producto: { imagen: @producto.imagen, nombre: @producto.nombre, precio: @producto.precio, usuario_id: @producto.usuario_id } }
    end
  ...
  test "should update producto" do
    patch producto_url(@producto), params: { producto: { imagen: @producto.imagen, nombre: @producto.nombre, precio: @producto.precio, usuario_id: @producto.usuario_id } }
